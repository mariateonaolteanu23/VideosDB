...
public final class Constants {
    ...
    public static final String NOT_APPLY = "Recommendation cannot be applied!";
    public static final String REC_RESULT = "Recommendation result: ";
    public static final String FACTORY_PACKAGE = "factory.";
    public static final String CRITERIA_PACKAGE = "criteria.";
    public static final String COMMAND_PACKAGE = "command.";
    public static final String QUERY_PACKAGE = "query.";
    public static final String REC_PACKAGE = "recommendation.";
    public static final String GENRE_FILTER = "3";
    public static final String BEST_UNSEEN = "BestRatedUnseen";
